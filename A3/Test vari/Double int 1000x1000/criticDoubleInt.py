...
print("Creating train,validation and test dataset...")
# Crea train, test e validation dataset 
train_dataset = dataset_shuffle.take(700000)

start_index_test = 850000
test_dataset = dataset_shuffle.skip(start_index_test).take(1500)

start_index_val = 700000
...
print(f"Time taken for training critic network: {elapsed_time}")
