...
if conf.TRACK_TRAJ:
    ...
    tests += [{'controller': 'OSC', 'kp': 2400,  'frequency': np.array([1.0, 1.0, 0.3]), 'friction': 2}]
    tests += [{'controller': 'IC',  'kp': 700,  'frequency': np.array([1.0, 1.0, 0.3]), 'friction': 2}]

    tests += [{'controller': 'OSC', 'kp': 4200,  'frequency': 3*np.array([1.0, 1.0, 0.3]), 'friction': 2}]
